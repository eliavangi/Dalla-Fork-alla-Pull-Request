...
Se desideri che i cambiamenti apportati vengano inseriti nella repo originale puoi inviare una *PullRequest*. Cliccare l'icona della *Pull Request* **new pull request**. Se le modifiche applicate non contrastano con il contenuto della repo originale apparira un'icona verde !con la scritta **create pull request**. cliccando sul pulsante "create pull request" verrà chiesto di inserire un titolo  e una descrizione della modifica effettuata (questo passaggio è opzionale). 
